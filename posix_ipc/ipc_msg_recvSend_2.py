...
mq_recv = posix_ipc.MessageQueue('/1_send_2', posix_ipc.O_CREAT)
mq_recv.block = False # non-blocking recv , send
mq_send = posix_ipc.MessageQueue('/2_send_1', posix_ipc.O_CREAT)
...
while True:
    #-------- Send ---------# 
    try:
        mq_send.send('elevator_reply',priority=9)
